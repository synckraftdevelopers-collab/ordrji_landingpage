      ...
      <main style={{ background: "#f8fafc", minHeight: "100vh", paddingTop: "7.5rem", paddingBottom: "5rem" }}>
        <div className="container" style={{ maxWidth: "1200px" }}>
          ...
          <div className="rr-pg-form-header" style={{ marginBottom: "2.5rem", textAlign: "center" }}>
            <span className="rr-pg-badge" style={{ display: "inline-flex", alignItems: "center", gap: "0.4rem", background: "rgba(249,115,22,0.1)", border: "1px solid rgba(249,115,22,0.25)", color: "#c2410c", padding: "0.3rem 0.9rem", borderRadius: "9999px", fontSize: "0.72rem", fontWeight: 700, letterSpacing: "0.6px", textTransform: "uppercase" }}>
              🍴 Restaurant Portal
            </span>
            <h1 className="rr-pg-title" style={{ fontSize: "clamp(2rem, 5vw, 3rem)", fontWeight: 900, letterSpacing: "-1.5px", lineHeight: 1.12, color: "#0f172a", marginTop: "0.75rem", marginBottom: "0.9rem" }}>
              Register Your Restaurant on <span style={{ background: "linear-gradient(120deg, #f97316, #ea580c)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>Ordrji</span>
            </h1>
